...
public class RestaurantMyOfferDatum {
    ...
    @Expose
    private RestaurantMyOfferRestaurant restaurant;
    ...
    public RestaurantMyOfferRestaurant getRestaurant() {
        return restaurant;
    }

    public void setRestaurant(RestaurantMyOfferRestaurant restaurant) {
