...
public class RestaurantEditProfileUser {
    ...
    @Expose
    private RestaurantEditProfileRegion region;
    ...
    public RestaurantEditProfileRegion getRegion() {
        return region;
    }

    public void setRegion(RestaurantEditProfileRegion region) {
        this.region = region;
    }
