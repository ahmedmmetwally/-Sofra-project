...
public class ClientOffersDatum {
    ...
    @Expose
    private ClientOffersRestaurant restaurant;
    ...
    public ClientOffersRestaurant getRestaurant() {
        return restaurant;
    }

    public void setRestaurant(ClientOffersRestaurant restaurant) {
