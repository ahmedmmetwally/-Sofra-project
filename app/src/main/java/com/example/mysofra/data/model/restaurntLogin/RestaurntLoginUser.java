...
public class RestaurntLoginUser {
    ...
    @Expose
    private RestaurntLoginRegion region;
    ...
    public RestaurntLoginRegion getRegion() {
        return region;
    }

    public void setRegion(RestaurntLoginRegion region) {
        this.region = region;
    }
