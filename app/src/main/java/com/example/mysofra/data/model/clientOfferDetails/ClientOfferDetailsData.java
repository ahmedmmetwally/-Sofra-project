...
public class ClientOfferDetailsData {
    ...
    @Expose
    private ClientOfferDetailsRestaurant restaurant;
    ...
    public ClientOfferDetailsRestaurant getRestaurant() {
        return restaurant;
    }

    public void setRestaurant(ClientOfferDetailsRestaurant restaurant) {
