...
public class RestaurntDetailsData {
    ...
    @Expose
    private RestaurntDetailsRegion region;
    ...
    public RestaurntDetailsRegion getRegion() {
        return region;
    }

    public void setRegion(RestaurntDetailsRegion region) {
        this.region = region;
    }
